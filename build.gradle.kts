...
repositories {
  // mavenLocal() // uncomment to testing locally build Besu plugin
...
jreleaser {
  project {
    description.set("Drop Transactions Reporter Besu Plugin")
    authors.set(listOf("Consensys Protocols Team"))
    license.set("Apache-2.0")
    inceptionYear.set("2024")
    copyright.set("2024, Consensys Software Inc.")
    links {
      homepage.set("https://github.com/Consensys/drop-transactions-reporter-plugin")
      documentation.set("https://github.com/Consensys/drop-transactions-reporter-plugin")
    }
  }
